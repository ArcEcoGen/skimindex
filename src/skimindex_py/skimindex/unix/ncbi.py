...
def help(tool_name: str) -> str:
    ...
    Args:
        tool_name: Name of the tool ("datasets" or "dataformat")
                   Can include subcommands (e.g., "datasets download genome")
    ...
    Examples:
        help("datasets")
        help("datasets download genome")
        help("dataformat convert")
    """
    try:
