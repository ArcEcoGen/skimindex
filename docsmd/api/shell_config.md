...
| Variable | Example value |
|---|---|
| `SKIMINDEX__PROCESSING__PREPARE_DECONTAM__OUTPUT` | `parts@decontamination` |
| `SKIMINDEX__PROCESSING__COUNT_KMERS_DECONTAM__TYPE` | `kmercount` |
| `SKIMINDEX__PROCESSING__COUNT_KMERS_DECONTAM__OUTPUT` | `kmercount@decontamination` |
| `SKIMINDEX__PROCESSING__COUNT_KMERS_DECONTAM__SEQUENCE` | `parts@decontamination` |
